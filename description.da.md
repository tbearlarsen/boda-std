# Save the Date — sidetekst (Dansk)

DRAFT — første oversættelse af den nuværende engelske tekst (`description.md`),
som endnu ikke er gennemgået af jer. Samme struktur som den engelske version,
sektion for sektion, så det er nemt at sammenligne og redigere. Rediger denne
fil, og bed derefter Claude om at synkronisere ændringerne til siden.
...
*(På siden: her sidder "Gem Datoen"-knappen, lige under datoen. Stedets navn/adresse gentages ikke her — det står kun i kort-sektionen længere nede på siden.)*
...
Hvad angår overnatning, er der en landsby 10 minutter fra stedet med masser af hoteller. Vi har nogle anbefalinger fra venuet som vi er i gang med at danne os et overblik over, men vi skal nok give dem videre til jer så hurtigt som muligt.


## 🇪🇸 Hvorfor ikke gøre det til en ferie?

Hvis I overvejer at blive i Spanien nogle ekstra dage, eller endnu længere, så sig endelig til! Vi vil meget gerne hjælpe jer med at planlægge en skøn spansk ferie når nu I skal til Spanien alligevel 🇪🇸☀️🍷
